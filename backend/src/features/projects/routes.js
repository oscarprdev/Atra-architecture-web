...
projectsRouter.post('/', [upload.array('newImages'), useCloudinary], ProjectsController.createNewProject);

projectsRouter.get('/:id', ProjectsController.provideProjectById);
projectsRouter.patch('/:id', [upload.array('newImages'), useCloudinary], ProjectsController.updateProject);
